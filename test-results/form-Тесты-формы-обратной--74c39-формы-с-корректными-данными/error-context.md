...
- Name: Тесты формы обратной связи на сайте Voxys >> Успешная отправка формы с корректными данными
- Location: C:\Users\adeli\Desktop\qa-internship-assignment-example\automation\tests\form.spec.ts:11:7
